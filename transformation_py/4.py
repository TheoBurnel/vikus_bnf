...
file_path = 'donnees/bases_images_merged.csv'  # Remplacez par le chemin de votre fichier
...
output_file_path = 'donnees/doublons.csv'  # Remplacez par le chemin de sortie souhaité

...
file_path = 'ligne1.csv'  # Remplacez par le chemin de votre fichier
df = pd.read_csv(file_path)

# Identifier les colonnes qui suivent le motif '_materiau'
materiau_columns = [col for col in df.columns if col.startswith('_materiau')]
...
output_file_path = 'keywords.csv'  # Remplacez par le chemin de sortie souhaité
